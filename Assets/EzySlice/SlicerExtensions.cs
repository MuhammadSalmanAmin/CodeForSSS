...
namespace EzySlice
{
    ...
    public static class SlicerExtensions
    {
         ...
         */
        public static GameObject[] SliceInstantiate(this GameObject obj, Plane pl,bool displayUpperHull,bool displayLowerHull)
        {
            return SliceInstantiate(obj, pl, new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f), displayUpperHull, displayLowerHull);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction, bool displayUpperHull, bool displayLowerHull)
        {
            return SliceInstantiate(obj, position, direction, null, displayUpperHull,displayLowerHull);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction, Material crossSectionMat, bool displayUpperHull, bool displayLowerHull)
        {
            return SliceInstantiate(obj, position, direction, new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f), displayUpperHull,displayLowerHull, crossSectionMat);
        }
        ...
        public static GameObject[] SliceInstantiate(this GameObject obj, Plane pl, TextureRegion cuttingRegion,bool displayUpperHull, bool displayLowerHull, Material crossSectionMaterial = null)
        {
            ...
            GameObject upperHull = slice.CreateUpperHull(obj,displayUpperHull);
            GameObject lowerHull = slice.CreateLowerHull(obj,displayLowerHull);
